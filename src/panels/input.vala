namespace ShadowSettings {
    public class InputPanel : Adw.PreferencesPage {
        construct {
            ...
            var mouse_settings = SafeSettings.try_get ("org.gnome.desktop.peripherals.mouse");
            var keyboard_settings = SafeSettings.try_get ("org.gnome.desktop.peripherals.keyboard");
            var touchpad_settings = SafeSettings.try_get ("org.gnome.desktop.peripherals.touchpad");
            var input_settings = SafeSettings.try_get ("org.gnome.desktop.input-sources");
